    ...
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
           <ul>
                ...
                <li><a class="nav-link scrollto active" href="<?php echo e(route('dashboard')); ?>">Dashboard</a></li>
...
<?php /**PATH C:\Users\User\Documents\GitHub\fyp\fyp\resources\views/navbar/dashboardleftbar.blade.php ENDPATH**/ ?>