...
<div class="wrapper d-flex align-items-stretch">
    <nav id="sidebar">
        <ul class="list-unstyled components mb-5">
            <li><a href="<?php echo e(route('course.bcdrcoursepage')); ?>"><span class="nav-link"></span>Business Continuity & Disaster Recovery <?php echo $__env->yieldContent('title'); ?></a></li><!-- Back to overview page -->
            <li><a href="<?php echo e(route('chapter.bcdrchapterpage')); ?>"><span class="nav-link"></span> Chapter 1</a></li>
...
<?php /**PATH C:\Users\User\Documents\GitHub\fyp\fyp\resources\views/navbar/bcdrleftbar.blade.php ENDPATH**/ ?>